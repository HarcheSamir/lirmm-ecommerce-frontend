                    ...
                    <table className="w-full text-sm text-left">
                        ...
                        <tbody>
                            {isLoading && orders.length === 0 ? (
                                ...
                                <tr><td colSpan="8" className="text-center p-8 text-gray-500">No orders found.</td></tr>
                            ) : (
                                orders.map(order => (
                                            ...
                                            <div className={`grid transition-all duration-300 ease-in-out ${expandedRowId === order.id ? 'grid-rows-[1fr] opacity-100' : 'grid-rows-[0fr] opacity-0'}`}>
                                                ...
                                                <div className="overflow-hidden bg-gray-50 p-4 border-t-2 border-primary/20">
                                                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 max-w-6xl mx-auto">
                                                        ...
                                                        {/* Column 2: Shipping & Summary */}
                                                        <div className="space-y-6">
                                                            <div>
                                                                <h4 className='font-semibold text-gray-700 mb-2 flex items-center gap-2'><PiTruck/> Shipping Details</h4>
                                                            ...
                                                            <div>
                                                                ...
                                                                <div className="text-sm bg-white p-4 rounded-lg border border-gray-200 space-y-2">
                                                                    <div className="flex justify-between"><span>Subtotal:</span><span className="font-medium">{formatCurrency(order.totalAmount - (order.shippingAddress?.shippingCost || 9.18))}</span></div>
                                                                    <div className="flex justify-between"><span>Shipping:</span><span className="font-medium">{formatCurrency(order.shippingAddress?.shippingCost || 9.18)}</span></div>
